    ...
    <>
      ...
      <Float speed={2} rotationIntensity={1.5} floatIntensity={2}>
        ...
        <mesh position={[0, 0, 0]}>
          ...
          <meshStandardMaterial color="#414141" roughness={0.1} metalness={0.8} />
        </mesh>
        ...
        <mesh position={[-2, -0.5, 1]} rotation={[1, 1, 0]}>
          <icosahedronGeometry args={[0.8, 0]} />
          <meshStandardMaterial color="#000099" roughness={0.2} metalness={1} />
        </mesh>

        <mesh position={[1, -1, 2]}>
          <sphereGeometry args={[0.2, 16, 16]} />
          <meshStandardMaterial color="#9292ff" emissive="#8a8aff" emissiveIntensity={1} />
        </mesh>
      </Float>
